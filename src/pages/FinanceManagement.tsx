...
const FinanceManagement = () => {
  ...
  const spendingData = [
    ...
    { category: 'Transportation', amount: 4200, percentage: 18, color: 'bg-green-500', trend: 'down' },
    ...
    <BankingLayout>
      <div className="min-h-screen bg-gray-50 pb-24">
        ...
        <div className="p-4 space-y-6">
          {/* Balance Overview */}
          <Card className="bg-gradient-to-r from-[#134e5e] to-[#71b280] text-white border-0 shadow-lg">
            <CardContent className="p-6">
              ...
              <div className="mt-4 p-3 bg-white/5 rounded-lg">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-green-300">₹12,400</span>
                </div>
                    ...
                    {investmentData.slice(0, 2).map((investment, index) => (
                      <div key={index} className={`bg-gradient-to-br ${investment.color} p-3 rounded-xl`}>
                        ...
                        <div className="flex items-center mt-1">
                          ...
                          <span className="text-xs text-green-600">+{investment.return}%</span>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  {investmentData.map((investment, index) => (
                    <div key={index} className={`bg-gradient-to-br ${investment.color} p-4 rounded-xl`}>
                      ...
                      <div className="flex items-center mt-2">
                        ...
                        <span className="text-sm text-green-600">+{investment.return}%</span>
                      </div>
                    </div>
                  ))}
                </div>
