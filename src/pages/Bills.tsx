...
const Bills = () => {
  ...
  const billCategories = [
    ...
    { key: 'insurance', label: 'Insurance', icon: <Shield className="h-5 w-5" />, color: 'bg-green-500' },
  ...
  const recentPayments = [
    { id: 1, bill: 'Electricity Bill', provider: 'PSPCL', amount: 2300, date: 'Jan 10', status: 'Paid', icon: <Zap className="h-5 w-5 text-green-600" /> },
    { id: 2, bill: 'Water Bill', provider: 'Municipal', amount: 750, date: 'Jan 8', status: 'Paid', icon: <Droplets className="h-5 w-5 text-green-600" /> },
  ];
    ...
    <BankingLayout>
      <div className="min-h-screen bg-gray-50 pb-16">
        ...
        <div className="p-4 sm:p-6 space-y-6 max-w-7xl mx-auto">
          ...
          <BankingCard
            title="Auto Pay"
            className="rounded-xl bg-gradient-to-r from-green-50 to-green-100 border-green-200 shadow-sm"
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-3 sm:space-y-0">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-green-800 text-sm sm:text-base">Set up Auto Pay</h3>
                  <p className="text-sm text-green-600 mt-1">Never miss a bill payment. Schedule automatic payments.</p>
                </div>
              </div>
              <Button className="rounded-xl bg-green-600 hover:bg-green-700 text-white text-sm sm:text-base h-10 sm:h-11 min-w-[100px]">
