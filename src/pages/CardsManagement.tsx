...
// import { useState, useEffect } from "react";
// import { ArrowLeft, CreditCard, Plus, Eye, EyeOff, Lock, Unlock, Settings, FileText, Gift, Phone, AlertCircle, CheckCircle, Loader2, ChevronDown, ChevronUp, MoreHorizontal, Key, Wifi, Globe, Zap, Shield, Calendar, Coins, BarChart3, Contact } from "lucide-react";
// import { useNavigate, useLocation } from "react-router-dom";
// import { Button } from "@/components/ui/button";
// import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@/components/ui/card";
// import { Badge } from "@/components/ui/badge";
...
//     switch (network) {
//       case "Visa":
//         return <div className="text-blue-800 font-bold text-xs"></div>;
//       case "Mastercard":
//         return <div className="text-red-600 font-bold text-xs"></div>;
//       case "RuPay":
...
//               <Button 
//                 size="sm" 
//                 className="flex items-center gap-1 h-9 rounded-full bg-gradient-to-r from-[#134e5e] to-[#71b280]" 
//                 onClick={() => navigate("/add-new-card")}
//               >
//                 <Plus className="h-4 w-4" />
//                 Add Card
...
//                             {card.contactlessEnabled && <Contact className="h-5 w-5" />}
//                             {card.onlineEnabled && <Wifi className="h-4 w-4" />}
//                             {card.internationalEnabled && <Globe className="h-4 w-4" />}
//                           </div> */}
//                         </div>
...
//                             {/* <div className={`w-12 h-12 rounded-xl ${application.color} flex items-center justify-center`}>
