  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 sm:px-6 py-5 max-w-screen-xl mx-auto">
        {/* Success Banner */}
        <Card className="bg-gradient-to-r from-[#1178AC]/10 to-[#1397DA]/10 border-[#1178AC]/20 mb-4">
          <CardContent className="p-5 text-center">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#1178AC]/20 mb-3">
              <CheckCircle2 className="h-6 w-6 text-[#1178AC]" />
            </div>
            <h2 className="text-base sm:text-lg font-semibold text-[#1178AC] mb-1">
        ...
        {/* Mandate Details */}
        <Card className="border-[#1178AC]/20">
          <CardContent className="p-4 space-y-3">
            <div>
              <h3 className="font-semibold text-base text-[#1178AC] mb-1">
                {mandateDetails.payeeName}
              </h3>
              <p className="text-xs text-muted-foreground">UPI ID</p>
              <p className="text-sm text-[#1178AC]">{mandateDetails.upiId}</p>
            </div>

            <div className="space-y-1 pt-2 border-t border-[#1178AC]/20">
              <div className="flex items-center text-xs">
                <span className="w-1.5 h-1.5 rounded-full bg-[#1178AC]/40 mr-2"></span>
                <span className="text-muted-foreground flex-1">Reference ID</span>
              </div>
              <p className="text-sm text-[#1178AC] ml-4">{mandateDetails.referenceId}</p>
            </div>

            <div className="space-y-1 pt-2 border-t border-[#1178AC]/20">
              <p className="text-xs text-muted-foreground">Remarks</p>
              <p className="text-sm text-[#1178AC]">{mandateDetails.remarks}</p>
            </div>

            <div className="pt-2 border-t border-[#1178AC]/20">
              <p className="text-xs text-muted-foreground mb-2">Mandate validity</p>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-muted-foreground">From</p>
                  <p className="text-sm font-medium text-[#1178AC]">{mandateDetails.validFrom}</p>
                </div>
                <div className="text-right">
                  <p className="text-xs text-muted-foreground">To</p>
                  <p className="text-sm font-medium text-[#1178AC]">{mandateDetails.validTo}</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-1 pt-2 border-t border-[#1178AC]/20">
              <div className="flex items-center justify-between">
                ...
                <p className="text-sm font-medium text-[#1178AC]">{mandateDetails.frequency}</p>
              </div>
            </div>
            ...
            <div className="space-y-1 pt-2 border-t border-[#1178AC]/20">
              <div className="flex items-center justify-between">
                ...
                <p className="text-sm font-medium text-[#1178AC]">{mandateDetails.cyclesCompleted}</p>
              </div>
            </div>
            ...
            <div className="space-y-1 pt-2 border-t border-[#1178AC]/20">
              <div className="flex items-center justify-between">
                ...
                <p className="text-base font-semibold text-[#1178AC]">{formatCurrency(mandateDetails.amountPerCycle)}</p>
              </div>
            </div>
            ...
            <div className="space-y-1 pt-2 border-t border-[#1178AC]/20">
              <div className="flex items-center justify-between">
                ...
                <p className="text-sm font-medium text-[#1178AC]">{mandateDetails.debitAccount}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-sm border-t border-[#1178AC]/20 z-50">
        <div className="px-4 sm:px-6 py-3 max-w-screen-xl mx-auto">
          <div className="grid grid-cols-2 gap-2">
            <Button
              variant="outline"
              className="h-12 font-medium text-[#1178AC] border-[#1178AC]/20 hover:bg-[#1397DA]/10 rounded-lg"
              onClick={() => navigate('/dashboard')}
            >
              Home
            </Button>
            <Button
              className="h-12 bg-gradient-to-r from-[#1178AC] to-[#1397DA] hover:from-[#0f3f4b] hover:to-[#5e9b6a] text-white font-medium rounded-lg"
